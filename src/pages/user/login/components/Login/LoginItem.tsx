...
import PhotoCaptcha from '../Captcha';
...
export interface LoginItemType {
  ...
  PCaptcha: React.FC<WrappedLoginItemProps>;
}
...
export interface LoginItemProps extends Partial<FormItemProps> {
  ...
  onTapClick?: (e: React.ChangeEvent<HTMLInputElement>) => void;
...
const getFormItemOptions = ({
  ...
  const options: {
    ...
    onTapClick?: LoginItemProps['onTapClick'];
      ...
      <FormItem shouldUpdate style={{ marginBottom: '0' }}>
        {() => (
          <Row gutter={8}>
            ...
            <Col span={8}>
              <PhotoCaptcha text={defaultValue} onClick={onTapClick} />
            </Col>
          </Row>
        )}
      </FormItem>
