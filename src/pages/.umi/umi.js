...
import findRoute, {
  getUrlQuery,
} from '/Users/caas/Desktop/boot-admin/beinuo-frontend/node_modules/umi-build-dev/lib/findRoute.js';
...
plugins.use(
  require('../../../node_modules/umi-plugin-antd-icon-config/lib/app.js'),
);
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3001,
      path: '/Users/caas/Desktop/boot-admin/beinuo-frontend',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
